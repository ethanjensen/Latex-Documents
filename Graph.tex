...
\begin{interface}[template parameter={V}, text width=3cm]{Iterable}{-1,-8.5}
...
\begin{class}[template parameter={V}, text width=6.5cm]{Vertex}{9.5,3}
  ...
  \operation{+ equals(other: Vertex<V>): boolean}
...
\begin{class}[template parameter={V, E}, text width=9.5cm]{Graph}{0,11}
  ...
  \operation{+ maxVertexWeight(): int}
  \operation{+ minVertexWeight(): int}
\end{class}
...
\begin{class}[template parameter={V, E}, text width=7.5cm]{Tree}{-1,0}
  ...
  \operation{+ iterator(): iterator<V>}
\end{class}

\begin{class}[text width=5cm]{DuplicateVertexException}{9,9}
\end{class}

\begin{class}[text width=5cm]{DuplicateEdgeException}{9,7.5}
\end{class}

\begin{class}[text width=5cm]{NoSuchVertexException}{9,6}
\end{class}

\begin{class}[text width=5cm]{NoSuchEdgeException}{9,4.5}
\end{class}
